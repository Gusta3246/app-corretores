            ...
            {pdfLeitor && (() => {
                ...
                return (
                    <div className="fixed inset-0 z-[60] flex flex-col" style={{background:'#0f0f0f'}}>
                        ...
                        {/* iframe ocupando o restante da tela */}
                        <div className="flex-1 relative" style={{background:'#0f0f0f', overflow:'hidden'}}>
                            {/* Loading atrás do iframe */}
                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-0 pointer-events-none" style={{background:'#0f0f0f'}}>

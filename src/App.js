                    ...
                    <div className="fixed inset-0 z-[60]" style={{background:'#0f0f0f'}}>
                        ...
                        >
                            <button
                                ...
                                className="pointer-events-auto w-11 h-11 flex items-center justify-center rounded-full text-white active:scale-95 transition-all"
                                style={{background:'rgba(0,0,0,0.6)', backdropFilter:'blur(10px)', WebkitBackdropFilter:'blur(10px)', border:'1px solid rgba(255,255,255,0.2)'}}
                            >
                                <X size={20} />
                            </button>
                            <a

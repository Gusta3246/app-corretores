    ...
    return (
        ...
        >
            ...
            <main className="main-content max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* ── BANNER + ABAS ── */}
                <div className="mb-6 relative shadow-lg banner-reveal" style={{
                    borderRadius: 24,
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end">
                        ...
                        {/* Abas maiores com destaque glass */}
                        <div className="mt-5 px-4 pb-4">
                            <nav ref={navRef} className="flex justify-center gap-1" aria-label="Tabs">
                                {[
                                    ...
                                    const baseStyle = {
                                        ...
                                        gap: 6,
                                        flexShrink: 0,
                                        transition: 'transform 0.18s cubic-bezier(0.34,1.56,0.64,1), background 0.25s ease, box-shadow 0.25s ease, border-color 0.25s ease',
                                    ...
                                    const inner = (
                                        <>
                                            <span style={{ fontSize:12, fontWeight:800, letterSpacing:'0.05em', color:'#fff', opacity: isActive ? 1 : 0.38, transition:'opacity 0.25s' }}>{tab.label}</span>
                                    ...
                                    return tab.isBtn ? (
                                        <button key={tab.id} ref={tabRefs[tab.id]} onClick={() => { haptic(); tab.action(); }} style={baseStyle} {...hoverProps}>
                                            {inner}
                                        </button>
                                    ) : (
                                        <a key={tab.id} href={tab.href} target="_blank" rel="noopener noreferrer" style={baseStyle} {...hoverProps}>{inner}</a>
                                    );
                                })}
                            </nav>
                        </div>

            ...
            {pdfLeitor && (() => {
                ...
                return (
                    <div className="fixed inset-0 z-[60]" style={{background:'#0f0f0f'}}>
                        ...
                        {/* Faixa sobre a toolbar do Drive — X e WhatsApp na esquerda, Drive nativo fica visível à direita */}
                        <div
                            className="absolute left-0 right-0 z-20 flex items-center px-3 gap-2 pointer-events-none"
                            style={{
                        ...
                        >
                            <button
                                ...
                                className="pointer-events-auto w-9 h-9 flex items-center justify-center rounded-full text-white active:scale-95 transition-all flex-shrink-0"
                            ...
                            {/* Espaço livre à direita — botão Drive nativo do iframe fica aqui */}
                            <div className="flex-1" />
                        </div>
